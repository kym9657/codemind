...
public class ServletMain extends HttpServlet {
	...
	private static void doGetCWE7(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			(new testcases.KRD_201_Missing_Authentication_for_Critical_Function.KRD_201_Missing_Authentication_for_Critical_Function__Servlet_getParameterServlet_equals_0101_bad()).runTest(request, response);
			(new testcases.KRD_201_Missing_Authentication_for_Critical_Function.KRD_201_Missing_Authentication_for_Critical_Function__Servlet_getParameterServlet_equals_0101_good()).runTest(request, response);
